...
class StoreReturnVoucherRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'voucher_number' => [
                ...
                'string',
                'max:50',
                new ValidReturnVoucherNumber($branchId)
            ],
    ...
    {
        return [
            'voucher_number.required' => 'رقم الإذن مطلوب',
            ...
            'issue_voucher_id.required' => 'إذن الصرف الأصلي مطلوب',
            ...
            'subtotal.required' => 'المجموع الجزئي مطلوب',
