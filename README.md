...
> **📁 ملاحظة مهمة**: تم إعادة تنظيم المشروع! اطلع على [PROJECT-ORGANIZATION.md](PROJECT-ORGANIZATION.md) لمعرفة الهيكل الجديد والمسارات المحدثة.

---

## ✨ المميزات

### 🏢 إدارة الفروع والمنتجات- ✅ **3 فروع**: المصنع، العتبة، إمبابة
...
### Option 1: Docker (الأسهل - كل حاجة مرة واحدة! 🐳)

```powershell
# تشغيل كل حاجة (Backend + Frontend + Database + Redis)
.\docker-start.ps1
```

**خلاص! 🎉** النظام شغال على:
- 🌐 Frontend: http://localhost:5173
- 🔌 Backend: http://localhost:8000
- 💾 phpMyAdmin: http://localhost:8080

📖 **للتفاصيل**: [DOCKER-QUICKSTART.md](DOCKER-QUICKSTART.md)
